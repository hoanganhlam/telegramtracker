...
interface IMartianWallet {
  ...
  onAccountChange: (listener: (newAddress: WalletAdapterNetwork) => void) => void;
  onNetworkChange: (listener: (network: WalletAdapterNetwork) => void) => void;
}
...
export class MartianWalletAdapter extends BaseWalletAdapter {
  ...
  constructor({timeout = 10000}: MartianWalletAdapterConfig = {}) {
    super();
